 ...
 * 各项比率
 */
public class CommonInputRateDialog extends Dialog {
    ...
    public CommonInputRateDialog(Context context, String unit, OnConfirmListener listener) {
...
//        this.setCanceledOnTouchOutside(false);
    ...
    private void initView() {
        tvUnit.setText(unit);
        etContent.setFilters(new InputFilter[]{new InputFilter.LengthFilter(2)});
    }
